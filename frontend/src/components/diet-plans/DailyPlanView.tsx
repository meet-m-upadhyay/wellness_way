...
interface DailyPlanViewProps {
  ...
  onRegenerateDay?: (useML: boolean) => void;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
        {meals.map(({ type, meal }) => (
          <MealCard
            ...
            meal={meal}
            mealType={type}
            onRegenerate={onRegenerateMeal ? (useML) => onRegenerateMeal(type, useML) : undefined}
